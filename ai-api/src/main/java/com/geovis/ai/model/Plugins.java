...
public class Plugins implements Serializable {
    ...
    /**
     * 插件包 默认0 未 1  2
     * @return pluginsbox_status 插件包 默认0 未 1  2
     */
    public Byte getPluginsboxStatus() {
        return pluginsboxStatus;
    }

    /**
     * 插件包 默认0 未 1  2
     * @param pluginsboxStatus 插件包 默认0 未 1  2
     */
    public void setPluginsboxStatus(Byte pluginsboxStatus) {
        this.pluginsboxStatus = pluginsboxStatus;
    }
    ...
    /**
     * 插件包地址
     * @return pluginsbox_url 插件包地址
     */
    public String getPluginsboxUrl() {
        return pluginsboxUrl;
    }

    /**
     * 插件包地址
     * @param pluginsboxUrl 插件包地址
     */
    public void setPluginsboxUrl(String pluginsboxUrl) {
        this.pluginsboxUrl = pluginsboxUrl == null ? null : pluginsboxUrl.trim();
    }
}