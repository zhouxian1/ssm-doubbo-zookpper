var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
        +'<div class="ts-title">Settings</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/> 固定上导航栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> 固定侧导航栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> 滚动侧导航栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> 侧导航栏方向</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> 定制侧导航栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> 侧导航栏开关</label>'
        +'</div>'
        +'<div class="ts-title">Style</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0" checked/> 全屏导航栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> 盒子导航栏</label>'
        +'</div>'
        +'<div class="ts-title">Themes</div>'
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="../theme-default.css"><img src="common/img/themes/default.jpg"/></a>'
            +'<a href="#" data-theme="../theme-forest.css"><img src="common/img/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="../theme-dark.css"><img src="common/img/themes/dark.jpg"/></a>'
            +'<a href="#" data-theme="../theme-night.css"><img src="common/img/themes/night.jpg"/></a>'
            +'<a href="#" data-theme="../theme-serenity.css"><img src="common/img/themes/serenity.jpg"/></a>'

            +'<a href="#" data-theme="../theme-default-head-light.css"><img src="common/img/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="../theme-forest-head-light.css"><img src="common/img/themes/forest-head-light.jpg"/></a>'
            +'<a href="#" data-theme="../theme-dark-head-light.css"><img src="common/img/themes/dark-head-light.jpg"/></a>'
            +'<a href="#" data-theme="../theme-night-head-light.css"><img src="common/img/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="../theme-serenity-head-light.css"><img src="common/img/themes/serenity-head-light.jpg"/></a>'
